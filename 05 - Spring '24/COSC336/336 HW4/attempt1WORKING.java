...
public class attempt1WORKING { 
    ...
    { 
        ...
        while (i < n) { 
            ...
            // top in stack is 'left index' 
                ...
                area_with_top 
                    = hist[tp].getY() 
                      * (s.empty() ? hist[i].getX() : hist[i].getX() - hist[leftIndex].getX());          //change me to factor in X width
        ...
        while (s.empty() == false) { 
            ...
            area_with_top 
                = hist[tp].getY()
                  * (s.empty() ? i : i - s.peek() - 1);              //change me to factor in X width
    ...
    { 
        ...
        File file = new File("input5.txt");                                  //PUT NEW FILES HERE
        ...
        while (z < hist.length){
            System.out.println(hist[z].toString());
            z++;
        }
        *///END DEBUGGING
